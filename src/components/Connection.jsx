    ...
    <>
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {connections.map((connection) => {
              const { _id, firstName, lastName, photoUrl, professionalStatus, institution, role } = connection;
              return (
                <div
                  key={_id}
                  className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200"
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* ✅ FIXED: BUTTONS SIDE-BY-SIDE WITH BETTER LAYOUT */}
                      <div className="mt-4 flex space-x-2">
                        {/* ✅ VIEW PROFILE BUTTON - SIDE BY SIDE */}
                        <button
                          onClick={() => handleViewProfile(connection)}
                          className="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-3 rounded-md transition-all duration-200 text-sm flex items-center justify-center space-x-1"
                        >
                          <svg
                        ...
                        <Link
                          to={"/chat/" + _id}
                          className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-3 rounded-md transition-all duration-200 text-sm flex items-center justify-center space-x-1"
                        >
                          <svg
                            className="w-3.5 h-3.5"
                            fill="none"
