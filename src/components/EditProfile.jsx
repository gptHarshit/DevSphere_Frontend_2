...
//   setError("");
//   try {
//     // ✅ PROJECTS DATA VALIDATION - YEH ADD KARO
//     const validatedProjects = projects.map(project => ({
//       ...project,
//       image: project.image && isValidUrl(project.image) ? project.image : ""
//     }));
...
//         photoUrl,
//         about,
//         projects: validatedProjects, // ✅ VALIDATED DATA USE KARO
//         certificates,
//         codingProfiles,
//         codingPlatforms,
//         contributions,
...
//                     disabled={!platformName.trim() || !profileUrl.trim()}
...
//                     disabled={
//                       !contributionTitle.trim() || !contributionType.trim()
//                     }
...
//                         project={project}
//                         onRemove={() => {
//                           // ✅ CORRECT: Both _id and id handle karo
...
const EditProfile = ({ user }) => {
  ...
  // ✅ ENHANCED ADD FUNCTIONS WITH VALIDATION
  const addProject = () => {
    const errors = validateProjectFields();
  ...
  // ✅ EXISTING REMOVE FUNCTIONS (UNCHANGED)
  const removeProject = async (projectId) => {
    try {
      const updatedProjects = projects.filter(
        (proj) => proj._id !== projectId && proj.id !== projectId
  ...
  // ✅ HELPER: Check if add button should be disabled
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              {/* PROJECTS SECTION WITH REAL-TIME VALIDATION */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-800">
                    Add Projects
              ...
              {/* CERTIFICATES SECTION WITH REAL-TIME VALIDATION */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-800">
                    Add Certificates
              ...
              {/* CODING PROFILES SECTION WITH REAL-TIME VALIDATION */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-800">
                    Coding Profiles
                ...
                <div className="space-y-4">
                  ...
                  {/* CODING PROFILE VALIDATION SUMMARY */}
              ...
              {/* CONTRIBUTIONS SECTION WITH REAL-TIME VALIDATION */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-800">
                    Contributions
